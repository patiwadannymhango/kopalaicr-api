...
Payment/target state machine. This lets apps/payments/services.py and
apps/payments/views.py stay gateway-agnostic; the only place that knows
which gateway is active is get_gateway() below.
"""
