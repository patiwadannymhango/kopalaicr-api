...
```
0 3 * * * /home/ubuntu/kopalaicr-api/infra/backup-db.sh >> /home/ubuntu/db-backups/backup.log 2>&1
```
...
```bash
./infra/restore-db.sh /home/ubuntu/db-backups/kopala_icr_20260101_030000.sql.gz
```
...
```bash
aws s3 cp s3://<bucket>/kopala_icr_20260101_030000.sql.gz /tmp/restore.sql.gz
